...
def RelacaoDeOPsSilk():
    ...
    FROM   
        ...
        WHERE 
            ...
            AND datamov > DATEADD(day, -20, CURRENT_TIMESTAMP)
        ) AS dados 
    INNER JOIN 
...
WHERE m.Empresa = 1 and m.codRequisicao > 0 and (produtoVar like '11%' or produtoVar like '2501%')
...
WHERE p.codEmpresa = 1 and p.codProduto  not like '8601000%' and p.codProduto  not like '83060062%'  and p.codProduto  not like '83060000%' and
p.codProduto not like '8302003%'
order by codPedido desc"""
